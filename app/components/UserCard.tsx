            ...
            <Card className="w-64 shadow-xl">
                <Flex gap="3" align="center">
                    ...
                    <Box>
                        ...
                        <Text as="div" size="2" color="gray" className="flex justify-center items-center gap-2" >
                            <IoBusiness/> {company?.name}
                        </Text>
                    </Box>
                </Flex>
                <Flex gap="3" justify="between" className="mt-5">
                    <Button className="cursor-pointer"><Link href={`/user/${id}`}>View Profile</Link></Button>
